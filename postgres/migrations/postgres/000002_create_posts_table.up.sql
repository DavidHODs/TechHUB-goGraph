...
CREATE TABLE IF NOT EXISTS tech.posts (
	...
	likes uuid REFERENCES tech.users (id) ON DELETE CASCADE ON UPDATE CASCADE UNIQUE,
	Dislikes uuid REFERENCES tech.users (id) ON DELETE CASCADE ON UPDATE CASCADE UNIQUE,
